...
config :justice_dialer,
  livevox_access_token: System.get_env("LIVEVOX_ACCESS_TOKEN"),
  livevox_clientname: System.get_env("LIVEVOX_CLIENT_NAME"),
...
config :justice_dialer, token_secret: System.get_env("TOKEN_SECRET")
